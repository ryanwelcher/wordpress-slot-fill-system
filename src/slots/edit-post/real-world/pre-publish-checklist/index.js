...
const PrePublishCheckList = () => {
	...
	return (
		<PluginPrePublishPanel title={'Publish Checklist'} initialOpen={true}>
			<p>
				<b>{__('WordCount:')}</b> {wordCountMessage}
			</p>
			<p>
				<b>{__('Categories:')}</b> {catsMessage}
			</p>
			<p>
				<b>{__('Tags:')}</b> {tagsMessage}
			</p>
			<p>
				<b>{__('Featured Image:')}</b> {featuredImage}
			</p>
